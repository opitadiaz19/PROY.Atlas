...
En el objetivo se hace referencia a \emph{libros con contenidos gráficos y numéricos en forma de atlas interactivos}, lo que es una especialización del concepto más general: \emph{libros digitales interactivos}. El concepto de libros interactivos tiene su origen en los libros \emph{pop-up} para niños, creados por Julian Wehr en la década de 1940 \citep{MBS2002, Bohem2002}. Estos libros tangibles, permiten a los niños interactuar con su contenido, mediante el accionar de las pestañas de papel o cartón, provistas en el libro para \emph{animar} o dar movilidad a las ilustraciones, tal como el que se muestra en la animación de abajo. Más tarde, con el advenimiento de los libros digitales o electrónicos, los portales \emph{Web} y los libros en línea \citep{Reilly2003}, la idea de que los lectores pudieran interactuar con su contenido permeó de los libros tangibles a los libros digitales en línea.
