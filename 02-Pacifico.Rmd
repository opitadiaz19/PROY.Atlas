...
```{r Mapa01, echo=F, out.width='95%', fig.show='hold', fig.cap='Rapidez y velociad de corriente en el Pacífico'}
# source("R/RasterVels.R", chdir = T, echo = F)
if (knitr::is_latex_output()){
  knitr::include_graphics("images/pacifico01.png")
} else if (knitr::is_html_output()){
  # knitr::include_url("https://geocompr.github.io/img/leaflet.html")
  VelMap("nc/datos_pacifico/p_m.nc") # profundidad 1
}
```
...
```{r Mapa02, echo=F, out.width='95%', fig.show='hold', fig.cap='Variable dp en el Pacífico a distintas profundidaes'}
# source("R/RasterVels.R", chdir = T, echo = F)
if (knitr::is_latex_output()){
  knitr::include_graphics("images/dp01.png")
} else if (knitr::is_html_output()){
  MuestraVar("nc/datos_pacifico/p_m.nc", "dp") 
}
```
